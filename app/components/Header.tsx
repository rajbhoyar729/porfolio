...
export default function Header() {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-blue-500 bg-opacity-90 backdrop-blur-sm shadow-lg' : 'bg-transparent'}`}>
